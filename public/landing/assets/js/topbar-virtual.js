$(function() {
 ...
 var typed = new Typed(".typing", {
  strings: ["لاتنتظر الفرصة بل اصنعها",  "تعلم مهنة وابدأ عملك" , "الجامعة الاسلامية خيارك الأول"],
  typeSpeed: 100,
  backSpeed: 60,
  loop: true
});
...
setInterval(nextSlide, 5000); // التحكم في الوقت بين التبديل بالميللي ثانية

showSlide(currentSlide); // عرض الشريحة الأولى عند تحميل الصفحة
*/
